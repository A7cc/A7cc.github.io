        ...
        return function (_em_module) {
            ...
            var asm = function (global, env, buffer) {
                ...
                function za(a, c, d) {
                    ...
                    if ((d | 0) > 0) {
                        ...
                        do {
                            ...
                            N = +J(.10000000149011612, + +(f[l + (e << 2) >> 2] | 0));
                            n[g + (e * 40 | 0) + 16 >> 2] = N;
                ...
                function kb(a) {
                    ...
                    while (1) {
                        if (f[i >> 2] | 0) {
                            ...
                            f[(f[l >> 2] | 0) + (g << 2) >> 2] = ~~(h + .0010000000474974513)
                        }
                        e = (f[j + (g << 2) >> 2] | 0) + e | 0;
                        g = g + 1 | 0;
                        if ((g | 0) == (m | 0)) break;
                ...
                function nb(a) {
                    ...
                    while (1) {
                        if (f[j >> 2] | 0) {
                            ...
                            f[(f[w >> 2] | 0) + (p << 2) >> 2] = ~~(i + .0010000000474974513);
                            b = f[A + (p << 4) + 12 >> 2] | 0;
                            k = b << 1;
                            l = f[(f[x >> 2] | 0) + (p << 2) >> 2] | 0;
                            b = (b | 0) > 0;
                ...
                function rb(a, b, c) {
                    ...
                    f[o >> 2] = q;
                    n[B >> 2] = 0;
                    k = (f[l + (a << 5) + 8 >> 2] | 0) == 1 ? -10 : -.10000000149011612;
                    n[B + 4 >> 2] = k;
                    f[s >> 2] = j;
                    j = s + 4 | 0;
                    f[j >> 2] = q;
                ...
                var qa = [Sc, ob, pb, Sc];
                return {
                    ___errno_location: Mb,
                    ___muldi3: xc,
                    ___udivdi3: Cc,
                    _bitshift64Lshr: Dc,
                    _bitshift64Shl: Ec,
                    _csmFree: Cb,
                    _csmGetDrawableConstantFlags: Ta,
                    _csmGetDrawableCount: Ra,
                    _csmGetDrawableDrawOrders: Wa,
                    _csmGetDrawableDynamicFlags: Ua,
                    _csmGetDrawableIds: Sa,
                    _csmGetDrawableIndexCounts: cb,
                    _csmGetDrawableIndices: db,
                    _csmGetDrawableMaskCounts: Za,
                    _csmGetDrawableMasks: _a,
                    _csmGetDrawableOpacities: Ya,
                    _csmGetDrawableRenderOrders: Xa,
                    _csmGetDrawableTextureIndices: Va,
                    _csmGetDrawableVertexCounts: $a,
                    _csmGetDrawableVertexPositions: ab,
                    _csmGetDrawableVertexUvs: bb,
                    _csmGetParameterCount: Ha,
                    _csmGetParameterDefaultValues: La,
                    _csmGetParameterIds: Ia,
                    _csmGetParameterMaximumValues: Ka,
                    _csmGetParameterMinimumValues: Ja,
                    _csmGetParameterValues: Ma,
                    _csmGetPartCount: Na,
                    _csmGetPartIds: Oa,
                    _csmGetPartOpacities: Pa,
                    _csmGetPartParentPartIndices: Qa,
                    _csmGetSizeofModel: Ea,
                    _csmInitializeModelInPlace: Fa,
                    _csmMalloc: Bb,
                    _csmMallocMoc: zb,
                    _csmMallocModelAndInitialize: Ab,
                    _csmReadCanvasInfo: Da,
                    _csmResetDrawableDynamicFlags: eb,
                    _csmReviveMocInPlace: Ca,
                    _csmUpdateModel: Ga,
                    _emscripten_replace_memory: la,
                    _free: Eb,
                    _i64Add: yc,
                    _i64Subtract: zc,
                    _llvm_bswap_i32: Fc,
...
(function (LIVE2DCUBISMPIXI) {
    ...
    var CubismMesh = (function (_super) {
        ...
        CubismMesh.prototype._renderWebGL = function (renderer) {
            ...
            else renderer.state.setFrontFace(0);
            if (this.isCulling === true) renderer.state.setCullFace(1);
            else renderer.state.setCullFace(0);
...
class Viewer {
    constructor(config) {
        ...
        window.onresize = (event) => {
            ...
            if (this.model) {
                this.model.position = new PIXI.Point(width * 0.25, height * 0.55);
                this.model.scale = new PIXI.Point(this.model.position.x * 0.22, this.model.position.x * 0.22);
